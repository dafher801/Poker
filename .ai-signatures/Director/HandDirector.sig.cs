// Source: Assets/Scripts/Director/HandDirector.cs
// HandDirector.cs
...
namespace TexasHoldem.Director
{
    public class HandDirector
    {
        ...
        {
            _stateMachine.RegisterCallback(RoundPhase.PreFlop, () => /* ... */;
            _stateMachine.RegisterCallback(RoundPhase.Flop, () => /* ... */;
            _stateMachine.RegisterCallback(RoundPhase.Turn, () => /* ... */;
            _stateMachine.RegisterCallback(RoundPhase.River, () => /* ... */;
            _stateMachine.RegisterCallback(RoundPhase.Showdown, () => /* ... */;
        }
        ...
        private async Task RunBettingRoundAsync(GamePhase phase, CancellationToken ct) { /* ... */ }
        {
            ...
            UnityEngine.Debug.Log($"[HandDirector] RunBettingRoundAsync 시작 - phase= { /* ... */ }
            ...
            UnityEngine.Debug.Log($"[HandDirector] 액션 순서: [ { /* ... */ }
            ...
            while (!roundComplete && !_handEnded)
            {
                ...
                foreach (int seatIndex in actionOrder)
                {
                    ...
                    UnityEngine.Debug.Log($"[HandDirector] 좌석 { /* ... */ }
