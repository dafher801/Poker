// Source: Assets/Scripts/View/ResultView.cs
// ResultView.cs
...
namespace TexasHoldem.View
{
    public class ResultView : MonoBehaviour
    {
        ...
        {
            Debug.Log($"[DEBUG][ResultView] ShowResult 진입. result null= { /* ... */ }
            ...
            Debug.Log($"[DEBUG][ResultView] SetActive(true) 호출 직전. 현재 active= { /* ... */ }
            gameObject.SetActive(true);
            Debug.Log($"[DEBUG][ResultView] SetActive(true) 호출 완료. 현재 active= { /* ... */ }
        }
