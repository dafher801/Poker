// Source: Assets/Scripts/Gateway/AiPlayerActionProvider.cs
...
namespace TexasHoldem.Gateway
{
    public class AiPlayerActionProvider : IPlayerActionProvider
    {
            ...
            CancellationToken ct)
        {
            ...
            var player = gameState.Players.FirstOrDefault(p => /* ... */;
            if (player == null)
